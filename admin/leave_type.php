 ...
 if(isset($_POST['add']))
{
     ...
     if ($count > 0){ 
        ...
        $query = mysqli_query($conn,"insert into tblleavetype (LeaveType, Description, NoDays)
  		 values ('$leavetype', '$description', '$days')      
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="NoDays" style="height: 5em;" class="form-control text_area" type="text"></textarea>
											</div>
										</div>
									</div>
