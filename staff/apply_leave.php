...
<?php
	...
	elseif($leave_days <= 0)
	{
		...
		mysqli_query($conn,"INSERT INTO tblleaves(LeaveType,ToDate,FromDate,Description,Status,IsRead,empid,num_days,PostingDate,assign_staff_id) VALUES('$leave_type','$todate','$fromdate','$description','$status','$isread','$empid','$num_days','$datePosting','$assigneeId')") or die(mysqli_error($conn));

		// $sql="INSERT INTO tblleaves(LeaveType,ToDate,FromDate,Description,Status,IsRead,empid,num_days,PostingDate) VALUES(:leave_type,
		// :fromdate,:todate,:description,:status,:isread,:empid,:num_days,:datePosting)";
								...
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											...
											<input name="firstname" type="text" class="form-control wizard-required" required="true" readonly autocomplete="off" value="<?php echo $row['emp_id']; ?>">
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label >Address</label>
											<input name="lastname" type="text" class="form-control" readonly required="true" autocomplete="off" value="<?php echo $row['Address']; ?>">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="form-group">
											...
											<select name="assigneeId" class="custom-select form-control" required="true" autocomplete="off">
											<option value="">Staff name...</option>
											<?php $sql = "SELECT emp_id,FirstName,LastName from tblemployees where role='Staff' and empid != $session_id";
											$query = $dbh -> prepare($sql);
											$query->execute();
											$results=$query->fetchAll(PDO::FETCH_OBJ);
											$cnt=1;
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												...
												<button class="btn btn-info" name="other" id="apply" data-toggle="modal" onclick="document.location='other.php'">Other&nbsp;Leave</button>
											</div>
