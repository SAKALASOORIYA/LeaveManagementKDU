...
<?php
	...
	$Day=date('d-m-Y', strtotime($_POST['date_tod']));
	...
	elseif($leave_days <= 0)
	{
		...
		$TD = date_create($_POST['date_tod']);

		$diff =  date_diff($DF , $DT );
		$num_days = (1 + $diff->format("%a"));

		$sql="INSERT INTO tblleaves(LeaveType,ToDate,FromDate,Description,Status,IsRead,empid,num_days,PostingDate,TodayDate) VALUES(:leave_type,
		:fromdate,:todate,:description,:status,:isread,:empid,:num_days,:datePosting,:Day)";
		...
		$query->bindParam(':date_tod',$date_to,PDO::PARAM_STR);
		echo "access";
		$query->execute();
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Other Leave Application</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="apply_leave.php">Apply Leave</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Other Leave</li>
								</ol>
							</nav>
						</div>
					</div>
							...
							<section>
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label >date</label>
											<input name="date_tod" type="text" class="form-control date-picker" required="true" autocomplete="off">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												...
												<!-- <button class="btn btn-primary" name="other" id="apply" data-toggle="modal" onclick="document.location='other.php'">Other&nbsp;Leave</button> -->
											</div>
